...
public class RegWithoutSigninRunner
{
	...
	public static void main(String[] args)throws Exception
	{
		...
		//Call methods from page class
			    ...
			    obj1.fillFirstname("test1.0755");
			    obj1.fillLastname("user");
			    obj1.fillemail("testuser1.0755@Example.com");
			    obj1.fillcred("DO");
			    obj1. Click1();
			    obj1.Click2();
			    obj1.checkout();
			    obj1.fillbfirstname("test3");
			    ...
			    obj1.fillusername("kalyani_409");
			    obj1.fillpassword1("Password11!");
			    obj1.fillcardnumber();
			    obj1.fillED();
			    obj1.fillcvc("145");
			    obj1.clickonorder();
