...
public class RegwithoutSigninpage 
{
    ...
    public void fillcardnumber()
    {
    	...
    	wait.until(ExpectedConditions.visibilityOf(cardnumber));
	     ...
	     jse.executeScript("arguments[0].value='"+ "4111111111111111" +"';", cardnumber);
    }
    public void fillED()
    {
    	
    	wait.until(ExpectedConditions.visibilityOf(ED));
    	JavascriptExecutor jse1= (JavascriptExecutor)driver;
    	jse1.executeScript("arguments[0].value='"+ "03/27" +"';", ED);;
    }
    ...
    public void clickonorder()
    {
    	...
    	JavascriptExecutor jsb = (JavascriptExecutor)driver;
		 jsb.executeScript("arguments[0].click();",placeorder);
    }
